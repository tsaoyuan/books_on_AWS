    ...
    <div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md space-y-8">
            ...
            <form class="mt-8 space-y-6" action="/login" method="POST">
                ...
                <div class="-space-y-px rounded-md shadow-sm">
                    ...
                    <div>
                        ...
                        <input id="email" name="email" type="email" class="p-2 relative block w-full rounded-t-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Email address" value="{{ old('email') }}">
                        @error('email')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class=" flex items-center justify-center gap-x-4">
                ...
                <a href="/auth/facebook" class="text-sm text-gray-500">Or login with Facebook <span aria-hidden="true">→</span></a>
            </div>
        </div>
    </div>
